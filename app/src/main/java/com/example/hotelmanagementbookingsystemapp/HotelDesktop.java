...
public class HotelDesktop extends AppCompatActivity {
    ...
    DatabaseHelper myDb;
    EditText Name, Surname, Bed, id, number;
    Button addButton;
    Button viewButton;
        ...
        updateButton.setOnClickListener(
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean IsUpdate= myDb.updateData(iden, user, surN, beding, num);
                        if(IsUpdate==true)
                        {
        ...
        addButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        boolean Isinserted= myDb.insertData(iden, user, surN, beding, num);
                        if (Isinserted==true)
                        {
